...
setup(
    ...
    packages=['storage_report'],
    package_dir={'storage_report': 'storage_report'},
    entry_points={
        'console_scripts': ['storage_report = storage_report.storage_report:main']
    },
    url='https://github.com/bjpop/storage_report',
    license='LICENSE',
