...
this_program_name="storage_report-test.sh"
...
${this_program_name}: run integration/regression tests for storage_report 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/storage_report -d data/tests
